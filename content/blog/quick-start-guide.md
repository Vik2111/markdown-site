---
title: "Быстрый старт: Инструкция к сайту"
description: "Как настроить проект с нуля и публиковать новые статьи"
date: "2025-12-23"
slug: "quick-start-guide"
published: true
tags: ["инструкция", "git", "setup"]
readTime: "5 min read"
excerpt: "Полное руководство по переустановке и работе с блогом для администратора."
---

# Быстрый старт: Markdown Site

Эта инструкция поможет настроить проект "с нуля" на новом компьютере или после очистки, а также расскажет, как публиковать статьи.
